...
This task describes how to access the iSCSI port configuration from the Hardware page. You can also access the configuration from the System page *menu:Settings[System]*.
