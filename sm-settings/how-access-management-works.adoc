...
summary: "Access Management is a method of establishing user authentication in SANtricity System Manager. Authentication requires users to log in to these systems with their assigned credentials."
---
