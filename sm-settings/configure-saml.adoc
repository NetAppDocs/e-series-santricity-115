...
* <<Step 1: Upload the IdP metadata file,Step 1: Upload the IdP metadata file>>
* <<Step 2: Export Service Provider files,Step 2: Export Service Provider files>>
* <<Step 3: Map roles,Step 3: Map roles>>
* <<Step 4: Test SSO login,Step 4: Test SSO login>>
* <<Step 5: Enable SAML,Step 5: Enable SAML>>
